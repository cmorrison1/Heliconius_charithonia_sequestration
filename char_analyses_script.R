...
#########################################
### - GLS of total adult CN content - ###
#########################################
### Did adults from some hosts acquire more total CN? 
### Also, were there sex differences in total CN? 
adult<-read.csv("char.adult.csv")
head(adult)
...
# check for homoscedasticity 
boxplot(ug.vol.correct~pair,data=hc) # heterogeneity of variance visible
bartlett.test(ug.vol.correct~pair,data=hc) # confirmed there is heterogeneity of variance 
...
# (Intercept)     392.2364  63.24397  6.201958  0.0000
# pairP.biflora  -278.3774  62.22005 -4.474079  0.0000
# pairP.lutea      39.6642 113.64377  0.349022  0.7284
# pairP.suberosa  -44.7817  71.65459 -0.624966  0.5346
# sexmale          39.1126  43.37385  0.901756  0.3711
anova(palatable)
#             numDF   F-value p-value
# (Intercept)     1 133.28795  <.0001
# pair            3  14.02593  <.0001
# sex             1   0.81316  0.3711
...
######################################
### - GLS of adult concentration - ###
######################################
### Did adults from some hosts acquire higher CN concentrations? 
### Also, were there sex differences in CN concentration? 
adult<-read.csv("char.adult.csv")
...
# check distribution
shapiro.test(resid(CONpalatable)) # W = 0.95513, p-value = 0.0273 --> close to normally distributed
plot(hist(resid(CONpalatable),breaks = 6))

summary(CONpalatable)
#                    Value Std.Error DF   t-value p-value
# (Intercept)     4.460536 0.8101625  5.505730  0.0000
# pairP.biflora  -3.274057 0.7963515 -4.111322  0.0001
# pairP.lutea     0.204652 1.3384743  0.152899  0.8790
# pairP.suberosa -0.038981 1.0198932 -0.038220  0.9697
# sexmale         0.536948 0.4022932  1.334719  0.1875
anova(CONpalatable)
#             numDF denDF   F-value p-value
# (Intercept)     1 110.13761  <.0001
# pair            3  15.22262  <.0001
# sex             1   1.78147  0.1875
