...
adult<-read.csv("char.adult.csv")
head(adult)
hc<-adult[,c('number','species','pair','ug','ug.vol.correct','ug.mg',"extraction.date")]
...
#            R2m       R2c
# [1,] 0.6705587 0.6997741
anova(palatable)
#             numDF denDF   F-value p-value
# pair            2    45  14.63750  <.0001
...
CONpalatable<-lme(ug.mg~pair,weights=varIdent(form=~1|as.factor(pair)),
                  random = ~1|number, method = "REML",data=adults)
...
# (Intercept)     4.834065 0.7703413 56  6.275225  0.0000
# pairP.biflora  -3.403519 0.7995269 56 -4.256916  0.0001
# pairP.lutea     0.061243 1.3509481 56  0.045334  0.9640
# pairP.suberosa  0.034947 1.0273081 56  0.034018  0.9730
r.squaredGLMM(CONpalatable) 
#            R2m       R2c
# [1,] 0.780438 0.8230917
anova(CONpalatable)
#             numDF denDF   F-value p-value
# (Intercept)     1    56 109.61607  <.0001
# pair            3    56  15.06883  <.0001
